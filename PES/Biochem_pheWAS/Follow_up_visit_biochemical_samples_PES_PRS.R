...
## Analysis from samples available from the follow-up visit
...
Biochem_traits <- fread("Follow_up_list__of_biochemical_fields.txt",
                        header = F)
...
write.table(Output, file = paste("Follow_up_visit_replication/Follow_up_", opt$disorder_name, "_", 
...
write.table(Male_output, file = paste("Follow_up_visit_replication/Follow_up_males/Follow_up_males_", opt$disorder_name, "_", 
                                      opt$score_name, ".txt", sep=""),
            sep = "\t", row.names = T, quote = F)
...
write.table(Female_output, file = paste("Follow_up_visit_replication/Follow_up_females/Follow_up_females_", opt$disorder_name, "_", 
                                        opt$score_name, ".txt", sep=""),
            sep = "\t", row.names = T, quote = F)
