...
setwd("~/Desktop/SZ_PES_mtCOJO_norm/Best_DA_gene_PES/UKBB_MHQ_no_self_reported_biochem/Entire_EUR_genotyped_UKBB_scores/Concatenated_PES_PRS_files/")
...
SZ_PRS_raw <- fread("UKBB_SZ_PRS_concatenated", header = T, sep="\t")
...
CACNA1C_PES_raw <- fread("UKBB_SZ_CACNA1C_concatenated", header = T, sep="\t")
...
GRIN2A_PES_raw <- fread("UKBB_SZ_GRIN2A_concatenated", header = T, sep="\t")
...
FES_PES_raw <- fread("UKBB_SZ_FES_concatenated", header = T, sep="\t")
...
FADS1_PES_raw <- fread("UKBB_SZ_FADS1_concatenated", header = T, sep="\t")
...
PCCB_PES_raw <- fread("UKBB_SZ_PCCB_concatenated", header = T, sep="\t")
...
RPS17_PES_raw <- fread("UKBB_SZ_RPS17_concatenated", header = T, sep="\t")
...
CACNA1C_PES_raw <- fread("UKBB_BIP_CACNA1C_concatenated", header = T, sep="\t")
...
GRIN2A_PES_raw <- fread("UKBB_BIP_GRIN2A_concatenated", header = T, sep="\t")
...
FES_PES_raw <- fread("UKBB_BIP_FES_concatenated", header = T, sep="\t")
...
FADS1_PES_raw <- fread("UKBB_BIP_FADS1_concatenated", header = T, sep="\t")
...
PCCB_PES_raw <- fread("UKBB_BIP_PCCB_concatenated", header = T, sep="\t")
...
RPS17_PES_raw <- fread("UKBB_BIP_RPS17_concatenated", header = T, sep="\t")
