...
setwd("~/Desktop/SZ_PES_mtCOJO_norm/Liberal_genic_boundaries_DA_gene_PES/BIP_TRAIN_liberal/")
...
All_BIP_scores <- fread("Combined_BIP_PES_PRS_train_LIBERAL_bound.txt", header = T, sep = " ")
...
write.csv(BIP_results, file="Results/Liberal_C_T_BIP_UKBB_PES_PRS_results.csv", quote = F, row.names = T)
...
write.csv(R2_liability_results, file="Results/Liberal_C_T_BIP_Liability_scale_r2_PES_PRS.csv", row.names = T, quote = F)
