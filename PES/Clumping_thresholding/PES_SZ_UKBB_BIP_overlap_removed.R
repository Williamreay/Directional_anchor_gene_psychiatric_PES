...
## Overlapping cases with BIP removed
...
write.csv(SZ_results, file="Results/Potential_BIP_removed_SZ_UKBB_PES_PRS_results.csv", quote = F)
...
write.csv(R2_liability_results, file="Results/BIP_removed_SZ_Liability_scale_r2_PES_PRS.csv", quote = F)
